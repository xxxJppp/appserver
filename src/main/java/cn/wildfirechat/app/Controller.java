...
public class Controller {
    ...
    @PostMapping(value = "/pwdlogin", produces = "application/json;charset=UTF-8"   )
    public Object pwdlogin(@RequestBody LoginRequest request) {
        return mService.pwdlogin(request.getName(), request.getPassword(), request.getClientId());
    }

    @PostMapping(value = "/register", produces = "application/json;charset=UTF-8"   )
    public Object createUser(@RequestBody LoginRequest request) {
        return mService.createUser(request.getName(), request.getPassword());
    }
